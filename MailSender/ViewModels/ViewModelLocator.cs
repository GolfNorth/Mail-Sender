...
namespace MailSender.ViewModels
{
    public class ViewModelLocator
    {
        public ViewModelLocator()
        {
            ...
            container.RegisterInstance<DbContextOptions>(new DbContextOptionsBuilder<MailSenderDB>()
                .UseLazyLoadingProxies().UseSqlite(App.Configuration.GetConnectionString("DefaultConnection")).Options);
